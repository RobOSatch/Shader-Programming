...
Shader::Shader(const GLchar* vertexPath, const GLchar* fragmentPath, const char* geometryPath, const char* transformFeedbackOutVar[], const unsigned int varAmount)
{
